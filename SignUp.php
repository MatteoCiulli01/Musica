			...
			<div id="modulo">
				<form method="post" >
						...
						<div id="eMail">
							...
							<input value= "<?php if(isset($_SESSION["eMail"])== true){ echo $_SESSION["eMail"]; }?>" name="eMail" type="text" class="form-control" id="eMail" placeholder="inserisci qui il tuo indirizzo eMail"	required>
                        </div>

                        <div id="eMail">
							<label>Conferma email</label>
							<input name="eMail" type="text" class="form-control" id="eMail" placeholder="conferma qui il tuo indirizzo eMail"	>
                        </div>

						<div id="Password">
						<label >Password</label>
						<input value= "<?php if(isset($_SESSION["Password"])== true){ echo $_SESSION["Password"]; }?>" name = "Password" type="password" class="form-control" id="Password"	placeholder="inserisci qui la tua password"	required>
                        </div>
                        
                        <div id="Username">
						<label >Username</label>
						<input value= "<?php if(isset($_SESSION["Username"])== true){ echo $_SESSION["Username"]; }?>" name = "Username" type="text" class="form-control" id="Username"	placeholder="Come ti dobbiamo chiamare?"	required>
                        </div>
